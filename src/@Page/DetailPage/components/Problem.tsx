...
const Problem = () => {
  ...
  return (
    <section className="flex flex-wrap bg-[#F6F9FF] py-[1.4rem] px-[1.25rem] desktop:px-[15rem] desktop:py-[6.25rem] tablet:p-[2rem] items-end desktop:items-start">
      <h2 className="desktop:w-full mx-auto tablet:w-[38%] desktop:order-1 tablet:order-2  desktop:text-[2.5rem] tablet:text-sb22 mb-[1.5rem] tablet:mb-0 desktop:mb-[5rem]  font-semibold">
