...
const Banner = () => {
  ...
  return (
    <section className=" flex items-center desktop:px-[15rem] tablet:px-[3.375rem] py-[6.25rem] justify-between">
      ...
      <div
        className={clsx(
          "tablet:w-1/2 laptop:w-2/5 desktop:w-2/5 h-[70vh] bg-cover flex items-center justify-center rounded-[50px]"
        )}
        style={{
