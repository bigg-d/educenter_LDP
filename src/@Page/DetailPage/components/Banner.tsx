...
const Banner = () => {
  ...
  return (
    <section className="flex tablet:flex-row flex-col items-center fhd:px-[15rem] laptop:px-[9.72%] tablet:px-[3.375rem] laptop:py-[6.25rem] tablet:py-[2.5rem] fhd:gap-[2.25rem] laptop:gap-[6.25rem] justify-between">
      <div className={clsx("w-full fhd:pr-[7.5rem] tablet:order-1 order-2 tablet:w-[48.75%]",{"px-5 py-7":mobile})}>
        ...
        <div className={clsx("flex mt-4 fhd:gap-4 tablet:gap-3", { "justify-evenly": mobile })}>
          <button className="rounded-[30px] cursor-pointer tablet:text-sb14 text-m14 fhd:text-[1.4rem] laptop:text-[1.1rem] inline-block bg-gradient-to-r from-mainBlue to-mainViolet py-2 px-4  laptop:px-6 laptop:py-4 text-white transition-all duration-300 hover:shadow-lg hover:-translate-y-[2px]">Đăng kí dịch vụ</button>
          <button className="rounded-[30px] cursor-pointer tablet:text-sb14 text-m14 fhd:text-[1.4rem] laptop:text-[1.1rem] px-4 py-2 inline-block bg-white text-[#4A4A4A] border-2 font-[500] laptop:px-6 laptop:py-4 transition-all duration-300 hover:shadow-lg hover:-translate-y-[2px];">Tư vấn miễn phí</button>
        </div>
        </Fade>
      </div>
      ...
      <div
        className={clsx(
          "hidden tablet:flex tablet:w-[45%] laptop:w-2/5 fhd:w-2/5 w-full fhd:h-[90vh] tablet:h-[50vh] bg-cover items-center justify-center tablet:rounded-[50px] tablet:order-2 order-1",
        )}
        style={{
