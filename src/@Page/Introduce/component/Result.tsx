  ...
  return (
    <div className="w-full h-auto py-10 flex gap-10 flex-col 2xl:gap-0">
      ...
      >
        ...
        <div
          className={clsx("", {
            " flex gap-5 w-[35%] 2xl:w-[19%]  h-[25%] 2xl:h-auto absolute top-[10%] 2xl:top-[18%] left-[5%] 2xl:left-[10%]":
              tablet,
        ...
        >
          ...
          >
            <span className="self-stretch text-zinc-900 text-[0.875rem] 2xl:text-[1.3rem] font-semibold  leading-tight">
              Tăng trưởng về quy mô
            </span>
            <span className="self-stretch text-zinc-600 text-[0.75rem]  font-medium ">
        ...
        <div
          className={clsx("", {
            "flex gap-5 2xl:w-[19%]  w-[35%] h-[25%] 2xl:h-auto top-[5%] right-[5%] absolute 2xl:top-[15%] 2xl:left-[40%]":
              tablet,
            "flex absolute top-[25%] flex-row-reverse  w-[80%] gap-5 h-[23%]":
              mobile,
          })}
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <span className="self-stretch text-zinc-600 text-[0.75rem] 2xl:text-base font-medium ">
              Số lượng học sinh từ 10.000 lên 20.000 trong vòng 5 năm, tăng số
              lượng nhân viên từ 100 lên 500 trong vòng 3 năm
            </span>
          </div>
        ...
        <div
          className={clsx("", {
            "md:hidden  2xl:flex gap-5 w-[19%]  absolute top-[18%] right-[10%]":
              tablet,
            hidden: mobile,
          })}
        >
          ...
          <div className="flex flex-col gap-2">
            <span className="self-stretch text-zinc-900 text-[1.3rem] font-semibold  leading-tight">
              Tăng trưởng về quy mô
            </span>
            <span className="self-stretch text-zinc-600 text-base font-medium ">
              Số lượng học sinh từ 10.000 lên 20.000 trong vòng 5 năm, tăng số
              lượng nhân viên từ 100 lên 500 trong vòng 3 năm
            </span>
          </div>
        ...
        <div
          className={clsx("", {
            "flex gap-5 2xl:w-[19%] w-[35%] h-[23%] 2xl:h-auto top-[31%] left-[43%] absolute 2xl:top-[37%] 2xl:right-[40%]":
              tablet,
        ...
        <div
          className={clsx("", {
            "flex gap-5 2xl:w-[19%] w-[35%] left-[13%] top-[52%] absolute 2xl:top-[55%] 2xl:left-[13%]":
              tablet,
            "flex absolute bottom-0 flex-row-reverse  w-[80%] gap-5 h-[23%]":
              mobile,
          })}
        >
        ...
        <div
          className={clsx("", {
            "flex gap-5 2xl:w-[19%] w-[35%] bottom-[13%] h-[25%] 2xl:h-auto right-[5%]  absolute 2xl:bottom-[20%] 2xl:left-[35%]":
              tablet,
            hidden: mobile,
          })}
        >
...
<div className="w-[360px] h-[680px] pt-[45.32px] pb-[30.68px] bg-white flex-col justify-end items-center gap-10 inline-flex">
  <div className="self-stretch px-6 py-2 bg-indigo-50 rounded-full justify-start items-center gap-1 inline-flex">
    <div className="text-center text-blue-600 text-sm font-semibold  leading-tight">
      Kết quả của hành trình phát triển
    </div>
  </div>
  <div className="w-[360px] h-[528px] relative flex-col justify-start items-start flex">
    <img
      className="w-[1719.26px] h-[451.40px] origin-top-left rotate-[177.43deg]"
      src="https://via.placeholder.com/1719x451"
    />
    <div className="justify-start items-start gap-[22.50px] inline-flex">
      ...
      <div className="w-60 flex-col justify-start items-start gap-[9px] inline-flex">
        ...
        <div className="self-stretch text-zinc-600 text-xs font-medium ">
          Số lượng học sinh từ 10.000 lên 20.000 trong vòng 5 năm, tăng số lượng
          nhân viên từ 100 lên 500 trong vòng 3 năm
        </div>
      </div>
    </div>
    <div className="justify-start items-start gap-[22.50px] inline-flex">
    ...
    <img
      className="w-[1719.26px] h-[293.90px] origin-top-left rotate-[2.57deg]"
      src="https://via.placeholder.com/1719x294"
    />
    <div className="justify-start items-start gap-[22.50px] inline-flex">
      <div className="w-60 flex-col justify-start items-start gap-[9px] inline-flex">
        <div className="self-stretch text-zinc-900 text-sm font-semibold  leading-tight">
