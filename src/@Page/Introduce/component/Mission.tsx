        ...
        <div className="flex gap-[2.875rem] relative flex-col md:flex-row items-center">
          ...
          >
            <div className="self-stretch  flex-col justify-start items-start gap-3.5 flex">
              <div className="self-stretch text-white 2xl:text-xl text-lg font-semibold  2xl:leading-loose leading-7">
                Cung cấp sản phẩm giáo dục toàn diện
              </div>
              <div className="self-stretch text-blue-200 2xl:text-base text-xs font-medium  leading-normal">
          ...
          <div
            className={clsx("", {
              "2xl:right-0 2xl:bottom-0 bottom-[-7rem]  2xl:w-[30%] w-[50%] 2xl: absolute text-zinc-900 2xl:text-3xl text-lg font-semibold  leading-9":
                tablet,
        ...
        <div className=" 2xl:w-[77%] w-full  flex flex-col ">
          {missionList.map((item, index) => (
            ...
            >
              ...
              >
                <span className="text-zinc-900 text-lg md:text-xl font-semibold  2xl:leading-loose">
                  {item.title}
                </span>
                <span className=" text-zinc-600 text:sm md:text-base font-medium  leading-normal 2xl:w-[36%]">
                  {item.text}
                </span>
              </div>
            </div>
