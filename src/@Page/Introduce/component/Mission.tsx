          ...
          >
            <div className="self-stretch  flex-col justify-start items-start gap-3.5 flex">
              <Fade
                direction="up"
                delay={1e3}
                className="self-stretch text-white fhd:text-[1.5rem] desktop:text-[1.3rem] desktop:leading-7 fhd:leading-9 laptop:text-[1rem] text-lg font-semibold   leading-7"
              >
              ...
              <Fade
                direction="up"
                delay={1e3}
                className="self-stretch text-blue-200 desktop:text-base text-xs font-medium  leading-normal"
              >
            ...
            <Fade
              direction="up"
              delay={1e3}
              className="px-5 py-3.5 laptop:px-4 w-full md:w-auto bg-white rounded-full border-2 border-white border-opacity-60 justify-center items-center gap-2 inline-flex"
            >
              <button className="text-center text-zinc-900 fhd:text-sb14  text-xs font-semibold  leading-tight">
      ...
      <div className="laptop:w-[80%] w-[85%] relative   mx-auto flex justify-end z-[1] mt-[30%] tablet:mt-0 laptop:mt-0">
        <div className=" laptop:w-[77%] w-full  flex flex-col ">
          {missionList.map((item, index) => (
            <Fade direction="up" delay={index * 1000}>
              <div
                key={index}
